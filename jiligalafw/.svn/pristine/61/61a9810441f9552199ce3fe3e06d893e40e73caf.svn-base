 ...
 * 
 */
public class CloudOrderApprovalVo extends BaseVo {
	 ...
	 * 计算方案：接口ID 36位
	 */
	private CloudMdmCPUSolnVo cloudCpuSoln;
	/**
	 * 磁盘方案：接口ID 36位
	 */
	...
	public CloudMdmCPUSolnVo getCloudCpuSoln() {
		return cloudCpuSoln;
	}
	...
	public void setCloudCpuSoln(CloudMdmCPUSolnVo cloudCpuSoln) {
