                  ...
                  <tr height="30">
                    ...
                    <td>
                    	<table width="100%"  border="0" cellpadding="0" cellspacing="0">
                    	  ...
                    	  <tr height="30">
                    	  	<td width="2%"></td>
                          	<td width="30%" height="30" align="left" class="f13_1"><input type="radio" name="radio" value=""/>北京数据中心</td>
                          	<td class="f13_1">
								北京数据中心位于xxxx，机房规模。
							</td>
                          </tr>
                          <tr height="30">
                    	  	<td width="2%"></td>
                          	<td width="20%" height="30" align="left" class="f13_1"><input type="radio" name="radio" value=""/>上海数据中心</td>
                          	<td class="f13_1">
								上海数据中心位于xxxx，机房规模。
							</td>
                          </tr>
