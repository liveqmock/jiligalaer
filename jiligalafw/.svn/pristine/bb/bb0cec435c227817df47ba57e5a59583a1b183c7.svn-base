...
function selectResource(){
	window.openwindow("${ctx}/singleProd/selectResource.do","选择资源",980,645);
...
function getProdList(prodTypeCond){
	var form = document.forms.listForm;
	form.action="${ctx}//singleProd/list.do?prodTypeCond="+prodTypeCond;
	form.submit();
}
</script>
<script type="text/javascript">
              ...
              <td align="center"  valign="top" bgcolor="#F2F2F2">
                ...
                <div id="middle_sheet_myR_01">
                  <table width="230" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="25" colspan="2" align="left" valign="middle" style="margin-left: 5px; padding-left: 5px;">
						<select name="prodTypeCond" onchange="getProdList(this.value)" style="width: 155px; height: 20px;">
						  <c:forEach var="item" items="${prodTypeList}" >
						     <option value="${item.itemCode }" <c:if test="${item.itemCode == prodTypeCond}">selected</c:if> >${item.itemName }</option>
						  </c:forEach>
						</select>
					  </td>
                    </tr>
                    ...
                    <tr valign="top">
                      <td colspan="2">
                      	<div id="order" style="height:270px; z-index:1; overflow-y: scroll;overflow-x:hidden; width: 97%;">
                    ...
                    <tr>
                      <td align="center" valign="middle" colspan="2" style="padding-left:2px;">
                      	<input type="text" class="text13" id="keyword" name="keyword" value="${keyword }" size="20" style="height: 15px;" onkeydown="keyDown()"/>
