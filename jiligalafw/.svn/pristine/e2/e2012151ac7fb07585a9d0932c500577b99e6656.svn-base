			     		...
			     		<table width="100%" border="0" cellspacing="1" cellpadding="1" >
			              <tr height="25">
			                ...
			                <td width="20%" align="left" class="f12_1">
							    ...
							    <img src="${ctx}/images/btn8.png" alt="关闭" width="101" height="30" border="0" align="absmiddle" style="cursor:pointer;" onclick="javascript:window.close();"/>
							    &nbsp;&nbsp;
			                </td>
			              </tr>
						  <tr height="30" bgcolor="#ffffff">
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#ffffff">
                  <tr height="30">
                    <td>
			     		...
			     		<table width="98.7%" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
