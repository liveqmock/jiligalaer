						...
						<table width="915" border="1" cellspacing="0" cellpadding="0">
							<tr>
								<td height="30" align="left" class="f18b3" valign="top">
									...
									<img src="${ctx}/images/btn31.png" alt="银联充值" width="101" height="30" border="0" align="absmiddle" style="cursor:pointer;" onclick="javascript:unionpay();"/>
									<img src="${ctx}/images/btn32.png" alt="支付宝充值" width="101" height="30" border="0" align="absmiddle" style="cursor:pointer;" onclick="javascript:alipay();"/>
								</td>
							</tr>						
							<tr>
								...
								<td align="left" valign="top">
									<ec:table items="list" var="item" onInvokeAction="query('${queryType }')"
										...
										<ec:row>
											...
											<ec:column property="payAmount" title="充值金额（元）" cell="number" format="#0.00" style="width:12%; text-align: right;"/>
											<ec:column property="remainingAmount" title="充值后余额（元）" cell="number" format="#0.00" style="width:12%; text-align: right;" />
											<ec:column property="remark" title="充值状态" value="成功" style="width:15%; text-align: center;" />
											<ec:column property="remark" title="备注" style="width:26%; text-align: left;" />       
										</ec:row>
									</ec:table>
								</td>
							</tr>
