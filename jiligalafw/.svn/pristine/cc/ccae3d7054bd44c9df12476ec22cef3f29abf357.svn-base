				    ...
				    <td align="left" valign="top">
				      <table width="788" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
				        <tr bgcolor="#92b8c1" height="20">
				          ...
				          <td width="13%" align="center" class="f12">创建时间</td>
					      ...
					      <table width="788" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
					        ...
					        %>
					         <tr bgcolor="<%=bgcolor %>" height="20" valign="top">
					            ...
					            --%>
					            <td width="20%" align="left" class="f12_1">${item.templateName }</td>
					            <td width="13%" align="left" class="f12_1">
					            ...
					            <td width="5%" align="left" class="f12_1">
					            	...
					            	<c:if test="${item.state != 'Destroyed' && item.state != 'Stopped' && item.state != 'Running'}">${item.state }</c:if>
					            </td>
