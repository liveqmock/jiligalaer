...
/**费用表*/
alter table cloud_user_expense modify column PAY_TOTAL_AMOUNT decimal(10,5);
alter table cloud_user_expense modify column EXP_TOTAL_AMOUNT decimal(10,5);
alter table cloud_user_expense modify column CREDIT_AMOUNT decimal(10,5);

/**充值表*/
alter table cloud_user_pay modify column PAY_AMOUNT decimal(10,5);
alter table cloud_user_pay modify column REMAINING_AMOUNT decimal(10,5);
/**审批备注*/
alter table cloud_order_approval add approval_remark NVARCHAR(500);



/** 系统运行状态 */
drop table if exists CLOUD_SYSTEM_CAPACITY;
create table CLOUD_SYSTEM_CAPACITY
(
	ID		varchar(32) not null,
	IF_ID		varchar(36) null,
	type		varchar(2) null,
	zoneid          varchar(36) null,
	zonename 	varchar(200) null,
	capacityused	varchar(50) null,
	capacitytotal	varchar(50) null,
	SYNC_TIME	datetime,
	DATA_STATE        integer,
	SYNC_CREATED_TIME DATETIME,
	primary key (ID)
