...
function next(){
	...
	var diskSolnId=$('input:radio[name="prodDiskSolnId"]:checked').val();
	//if (diskSolnId != null){
...
function quickBuy(){
  ...
  <body onLoad="">
    <form:form modelAttribute="cloudProductCustomBuyVo" action="${ctx}/customBuy/diskResource.do" method="post" name="listForm">
              ...
              <td align="left" valign="top" bgcolor="#F0F1F2">
                <table width="336" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="301" align="left" valign="middle" class="f18b2">请选择您需要的磁盘资源</td>
                  </tr>
                  <tr>
                    ...
                    <td>
					  ...
					  <table width="670" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
                       	<tr bgcolor="#92b8c1" height="20">
                         	...
                         	<td width="39%" align="center" class="f12">价格</td>
                         	<td width="6%" align="center" class="f12">选择</td>
                        </tr>
                      </table>
                      <div style="height:343px; z-index:1; overflow-y: scroll; overflow-x: hidden;">   
                          <table width="670" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
                          
                          	<%int rowNumber=0; %>
                           	<c:forEach var="item" items="${diskSolnList}" varStatus="status">
                               ...
                               <td width="39%" align="left" class="f12_1">${item[6]}</td>
                               <td width="6%" align="center" class="f12_1">
                               	<form:radiobutton path="prodDiskSolnId" value="${item[0]}" />
                               </td>
                            </tr>
                           </c:forEach>
