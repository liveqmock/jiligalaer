...
function next(){
	var count = $("#hostAmount").val().replace(/\s/g, "");
	var vmName = $("#hostName").val().replace(/\s/g, "");
	var stopTime = $("#stopHostTime").val().replace(/\s/g, "");
...
function previous(){
	var form = document.forms.listForm;
	//form.action="${ctx}/customBuy/networkSolution.do";
...
function quickBuy(){
  ...
  <body onLoad="openIpList('${cloudProductCustomBuyVo.ipAllocatType}')">
    <form:form modelAttribute="cloudProductCustomBuyVo" action="${ctx}/customBuy/hostConfig.do" method="post" name="listForm">
                ...
                <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr height="35">
                    ...
                    <td>
                    	...
                    	<table width="100%"  border="0" cellpadding="0" cellspacing="0">
                    	  <tr height="35">
                          	<td width="20%" align="left" class="f13_1">数量：</td>
                          	<td class="f13_1">
                          		<form:input path="hostAmount" id="hostAmount" type="text" onkeypress="onlyNum(this.form);"  class="text13" maxlength="2"  size="5" />&nbsp;台&nbsp;(最多10台)&nbsp;&nbsp;
                          		<font size="2" color="red"><form:errors path="hostAmount" /></font>
                          	</td>
                          </tr>
                          <tr height="35">
                          	<td width="20%" align="left" class="f13_1">主机名：</td>
                          	<td class="f13_1">
                          		<form:input path="hostName" id="hostName" type="text"  class="text13" size="30" maxlength="35"/>&nbsp;&nbsp;
                          		<font size="2" color="red"><form:errors path="hostName" /></font>
                          	</td>
                          </tr>
                          ...
                          <c:when test="${cloudProductCustomBuyVo.prodDisk.customized=='true'}">
                          	<tr height="35">
                          	<td width="20%" align="left" class="f13_1">自定义磁盘大小：</td>
                          	<td class="f13_1">
                          		<form:input path="diskSize" onkeypress="onlyNum(this.form);"  maxlength="6"  type="text" class="text13" size="6" />
                          		G&nbsp;<font size="2" color="red"><form:errors path="diskSize" /></font>
                          	</td>
                          </tr>
                          </c:when>
                          </c:choose>
                          ...
                          <tr height="35">
                          	<td width="20%" align="left" class="f13_1">停机时间：</td>
                          	<td class="f13_1">
                          		<form:input path="stopHostTime" class="date_but" size="30" onfocus="WdatePicker({startDate: '%y-%M-%d 00:00:00', dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate: true })" readonly="true" id="stopHostTime" style="width: 150px;"/>&nbsp;&nbsp;
                          		<font size="2" color="red"><form:errors path="stopHostTime" /></font>
                          	</td>
                          </tr>
                          
                          <tr height="35">
                          	<td width="20%" align="left" class="f13_1">IP地址：</td>
                          	<td>
	...
	function selectIP(){
		var zoneid = '${cloudProductCustomBuyVo.mdmZoneId }';
