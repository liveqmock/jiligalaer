							...
							<table width="100%" border="0" cellspacing="1" cellpadding="0">
								<tr height="25">
									...
									<td width="220" align="right"">
										<img src="${ctx}/images/btn22.png" alt="添加管理员" width="101" height="30" border="0" align="absmiddle" style="cursor:pointer;" onclick="javascript:doAdd();"/>
										&nbsp;&nbsp;
								    </td>
								</tr>
								<tr height="25">
								...
								<tr>
									...
									<table width="100%" border="0" cellspacing="1" cellpadding="0"
										...
										<tr height="25">
											<td width="30">&nbsp;</td>
											<td class="f13_1" align="left">账号：</td>
					...
					<td align="left" valign="top">
					  <ec:table items="list"
						...
						<ec:row>
							...
							<ec:column property="null" title="姓名" style="width:15%; text-align: left;">
								<div style="text-decoration: underline; cursor: pointer" onclick="doEdit('${item.userId}')"> ${item.userName}</div>
							</ec:column>

							<ec:column property="userAccount" title="账号" style="width:20%; text-align: left;" />
