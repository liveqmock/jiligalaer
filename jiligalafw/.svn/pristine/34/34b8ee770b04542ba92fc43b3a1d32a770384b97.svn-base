					...
					<table width="915" border="0" cellspacing="0" cellpadding="0">
					  <c:if test="${userFlag == 1 }">
		                  <tr height="30" valign="top">
		                    <td height="30" align="left" class="f18b3" valign="top">账户余额：<fmt:formatNumber pattern="#0.00">${expVo.payTotalAmount - expVo.expTotalAmount }</fmt:formatNumber>元</td>
		                  </tr>
		                  <tr>
		                    ...
		                    <td class="f13_8">
			                    <c:choose>
			                    	<c:when test="${item.month==monthDate}">
			                    		...
			                    		<a href="javascript:monthQuery('${item.month}')" class="f13_7">${item.monthTitle}(<fmt:formatNumber pattern="#0.00">${item.billTotal}</fmt:formatNumber>元)</a>
			                    	</c:when>
			                    	<c:otherwise>
			                    		<td background="${ctx}/images/menu_s.jpg" align="left" class="f13_7">
			                    		<a href="javascript:monthQuery('${item.month}')" class="f13_8">${item.monthTitle}(<fmt:formatNumber pattern="#0.00">${item.billTotal}</fmt:formatNumber>元)</a>
			                    	</c:otherwise>
			                    </c:choose>
		                    </td>
		                    </tr>
                      		...
                      		<table border="0" cellspacing="0" cellpadding="0">
                      			<tr>
                      			  <td height="20" align="left">
                      				<span class="f13_6">账单总额：&nbsp;<fmt:formatNumber pattern="#0.00">${expTotal}</fmt:formatNumber>&nbsp;元</span>
	                              ...
	                              <td align="left" valign="top">
	                            	<table width="711" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
		                                <tr bgcolor="#92b8c1" height="20">
		                                  ...
		                                  <td width="10%" align="center" class="f12">明细</td>
		                                </tr>
                              		</table>
		                                ...
		                                <%int rowNumber=0; %>
	       								<c:forEach var="item" items="${expList}" varStatus="status" >
			                                <tr  <% if (rowNumber%2 == 0) {%> bgcolor="#EEF6F7" <% } else { %> bgcolor="#DEECEF" <% } %> height="20">
			                                    ...
			                                    <td width="40%" align="right" class="f12_1"><a style="text-decoration: underline; cursor: pointer" href="javascript:detail('${item[0]}')" ><fmt:formatNumber pattern="#0.00">${item[1]}</fmt:formatNumber></a></td>
			                                    <td width="10%" align="center" class="f12_1">
			                                      <a href="javascript:detail('${item[0]}')" >
