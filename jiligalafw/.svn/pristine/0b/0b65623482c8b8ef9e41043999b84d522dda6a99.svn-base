...
public class DozerBeanMapper implements Mapper {
	...
	private static final Logger log = LoggerFactory
			.getLogger(DozerBeanMapper.class);
	 ...
	 *            URLs referencing custom mapping files
	 * @see java.net.URL
	 */
	...
	void loadCustomMappings() {
		...
		LoadMappingsResult loadMappingsResult = customMappingsLoader.load(
				mappingFiles, builderMappings);
	...
	public void setEventListeners(
			List<? extends DozerEventListener> eventListeners) {
		checkIfInitialized();
	 ...
	 *            converter id to converter instance map
	 */
	 ...
	 */
	@Override
	public <T> T moveCheck(Object source, Class<T> destinationClass,Class<?> ... clzzs)
			throws MappingException {
		return  getMappingProcessor().moveCheck(source, destinationClass,clzzs);
	}
	...
	public void moveCheck(Object source, Object destination,Class<?> ... clzzs)
			throws MappingException {
		getMappingProcessor().moveCheck(source, destination,clzzs);
	}
	 ...
	 */
	@Override
	public void moveIgnoreNull(final Object source,final Object destination)
			throws MappingException {
...
//        });
		...
		DoFieldMoveUtil.addMapping(this, source, destination);
		getMappingProcessor().moveIgnoreNull(source, destination);		
	}
	 ...
	 */
	@Override
	public void moveCheckIgnoreNull(final Object source,final Object destination,Class<?> ... clzzs)
			throws MappingException {
//		addMapping(new BeanMappingBuilder() {
//    		@Override
//    		protected void configure() {
//    			DoFieldMoveUtil.mappings(this, source, destination);
////    	        mapping(
////    	        		source.getClass(),
////    	        		destination.getClass(),
////    	        		mapNull(false)
