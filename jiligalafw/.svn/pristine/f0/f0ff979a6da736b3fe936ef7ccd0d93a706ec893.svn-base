      ...
      <div id="middle" style="height:300px">
        <div id="register">
    	    <table width="952" height="280" border="0" cellpadding="0" cellspacing="0" align="center">
				    <tr height="60">
				    	<td width="2%" ></td>
				    	<td colspan="7" class="f18_1">注册成为瑞云浩天云计算门户系统的账户</td>
				    </tr>
				    <tr height="40">
				    	<td width="2%" ></td>
				    	<td width="2%" ></td>
				    ...
				    <tr height="10" style="padding-top: 0px">
				    	...
				    	<td class="f12" colspan="6" style="text-align: center">
							<p style="font-size: 13px;">恭喜注册成功！</p>
							<p style="font-size: 13px;">我们已经向您的邮箱发送了一封确认邮件，您需要点击邮件内的激活链接对账户进行激活！</p>
