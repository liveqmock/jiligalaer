  ...
  <body>
    ...
    <table height="100%" width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
      <tr bgcolor="#deecef" height="25" >
        ...
        <td width="80%" height="25" align="left" class="f12_1">&nbsp;&nbsp;IP地址</td>
      </tr>   
      <tr bgcolor="#eef6f7" height="25" >
        <td width="20%" height="25" align="left" class="f12_1">&nbsp;&nbsp;IP个数：</td>
        <td width="80%" height="25" align="left" class="f12_1">&nbsp;&nbsp;${ipNum}</td>
      </tr>                                                                                                       
      <tr bgcolor="#deecef" height="25" >
        <td width="20%" height="25" align="left" class="f12_1">&nbsp;&nbsp;描述：</td>
        <td width="80%" height="25" align="left" class="f12_1">&nbsp;&nbsp;</td>
      </tr>
    </table>
