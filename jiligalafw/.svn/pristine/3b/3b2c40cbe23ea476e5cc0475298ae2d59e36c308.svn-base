...
<title>我的资源 - 我的网络 - VPC网络 - 出口规则维护</title>
...
function add(){
	window.location.href="${ctx}/network/saveOutRule.do";
}
function back(){
  ...
  <body onLoad="">
    <form:form modelAttribute="baseVoList" action="${ctx}/network/saveOutRule.do" method="post" name="listForm">

					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr bgcolor="#ffffff" height="40">
					  	<td width="10"></td>
					  	<td class="f16_1">VPC网络01&nbsp;&nbsp;>&nbsp;&nbsp;出口规则</td>
					  	<td width="10"></td>
					  </tr>
                      <tr>
                      	<td width="10"></td>
	                      	...
	                      	<tr height="20" bgcolor="#ffffff" >
                          	  <td>       	  
                           		<table width="100%" border="0" cellspacing="1" cellpadding="0">
                                    <tr height="30">
                                  	  <td width="25%" class="f13_1" align="left">CIDR：<input type="text" name="" value="" size="10"/></td>
                                      <td width="25%" class="f13_1" align="left">起始端口：&nbsp;&nbsp;<input type="text" name="" value="" size="10"/></td>
                                      <td width="25%" class="f13_1" align="left">终止端口：&nbsp;&nbsp;<input type="text" name="" value="" size="10"/></td>
                                    ...
                                    <tr height="30">
                                      ...
                                      <td width="25%" class="f13_1" align="left">ICMP类型：<input type="text" name="" value="" size="10"/></td>
                                      <td width="25%" class="f13_1" align="left">ICMP代码：<input type="text" name="" value="" size="10"/></td>
