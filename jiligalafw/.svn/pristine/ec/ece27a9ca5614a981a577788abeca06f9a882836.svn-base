	    ...
	    <td align="left" valign="top">
	        <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
	           <tr bgcolor="#eef6f7" height="25">
	             <td width="15%" align="left" class="f12_1">&nbsp;&nbsp;姓名：</td>
	             <td width="70%" align="left" class="f12_1">${basicUser.userName }</td>
	           </tr>  	        
	          <tr bgcolor="#deecef" height="25">
	             <td width="15%" align="left" class="f12_1">&nbsp;&nbsp;账户名：</td>
	           ...
	           <tr bgcolor="#deecef" height="25">
	             <td width="15%" align="left" class="f12_1">&nbsp;&nbsp;注册日期：</td>
	             <td width="70%" align="left" class="f12_1"><fmt:formatDate pattern="yyyy-MM-dd" value="${basicUser.registerDate }"></fmt:formatDate></td>
	           </tr> 	             
	           <tr bgcolor="#eef6f7" height="25">
