          ...
          <td align="left" valign="top" bgcolor="#FFFFFF" height="350">
     		...
     		<table width="790" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
              <tr bgcolor="#92b8c1" height="20">
                ...
                <td width="10%" align="center" class="f12">带宽大小(M)</td>
              ...
              <table width="790" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
				  ...
				  <c:forEach var="item" items="${list}" >
					...
					<tr bgcolor="<%=bgcolor %>" height="20">
	                  ...
	                  <td width="40%" align="left" class="f12_1" title="${item.name }">${fn:substring(item.name,0,50) }</td>
	                  ...
	                  <td width="5%" align="center" class="f12_1">
	                  	<input type="radio" name="radio" id="radio1" value="${item.id }" onclick="selectVal('${item.id }','networkSoln','${item.name }')">
	                  </td>
	                </tr>
	              </c:forEach>
