...
public class ClassMap {
  ...
  public void setMapNull(boolean mapNull) {
	if(srcClass!=null){
		srcClass.setMapEmptyString(mapNull);
	}
	if(destClass!=null){
		destClass.setMapEmptyString(mapNull);
	}
  ...
  public void setMapEmptyString(boolean mapEmptyString) {
	...
	if(srcClass!=null){
		srcClass.setMapEmptyString(mapEmptyString);
	}
	if(destClass!=null){
		destClass.setMapEmptyString(mapEmptyString);
	}
