...
<script type="text/javascript">
	...
	function refund(id){
		window.location='${ctx}/processRefund/edit.do?id='+id;
	}
</script>
								...
								<td align="left" valign="top">
									...
									<ec:table items="list" var="item" onInvokeAction="doQuery('${queryType }')"
										...
										<ec:row>
											...
											<ec:column property="basicUser.userName" title="姓名" style="width:9%; text-align: left;" alias="userName" >
											...
											<ec:column property="applyAmount" title="申请金额（元）" cell="number" format="#0.00" style="width:9%; text-align: right;"/>
											...
											<ec:column property="refundAmount" title="退款金额（元）" cell="number" format="#0.00" style="width:9%; text-align: right;"/>
											<ec:column property="refundRemark" title="退款备注" style="width:10%; text-align: left;"/>
											<ec:column property="stateName" title="退款状态" style="width:5%; text-align: center;" />
