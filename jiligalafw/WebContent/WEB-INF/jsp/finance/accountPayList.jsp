...
<script type="text/javascript">
	...
	function pay(){
		window.location="${ctx}/accPay/edit.do";
	}
	function edit(id){
												...
												<table width="100%" border="0" cellspacing="1" cellpadding="0">
													...
													<tr height="25">
														...
														<td width="180" align="right">
														    <img src="${ctx}/images/btn18.png" alt="充值" width="101" height="30" border="0" align="absmiddle" style="cursor:pointer;" onclick="javascript:pay();"/>
														    &nbsp;&nbsp;
														</td>
													</tr>
													<tr height="25">
								...
								<td align="left" valign="top">
									...
									<ec:table items="list" var="item" onInvokeAction="doQuery('${queryType }')"
										...
										<ec:row>
											...
											<ec:column property="basicUser.userAccount" title="账户名" style="width:15%; text-align: left;" alias="userAccount" />
											<ec:column property="basicUser.userName" title="姓名" style="width:10%; text-align: left;" alias="userName" >
												<!--a href="javascript:edit('${item.basicUser.userId}')"  style="text-decoration:underline;cursor:pointer">
													
												</a>  -->
												${item.basicUser.userName}
											</ec:column>
											<ec:column property="basicUser.geoDictItem.itemName" title="地区" style="width:13%; text-align: left;" alias="region" />
											...
											<ec:column property="payTypeName" title="充值方式" style="width:10%; text-align: left;" />
											<ec:column property="payAmount" title="充值金额（元）" cell="number" format="#0.00" style="width:10%; text-align: right;"/>
											<ec:column property="remainingAmount" title="充值后余额（元）" cell="number" format="#0.00" style="width:10%; text-align: right;" />
