...
function save(){
	...
	if(confirm("确认增加该磁盘吗？")){
		...
		form.action="${ctx}/myVm/changeDisk.do?priceId="+priceId+"&prodItemId="+prodItemId+"&prodId="+prodId+"&orderId="+orderId;
		waitloading();
		form.submit();
	}
}
            ...
            <tr>
              <td align="center"  valign="top" bgcolor="#F2F2F2">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="50" align="left" valign="bottom"><span class="f16b2">增加磁盘资源</span></td>
                          ...
                          <tr>
                            ...
                            <c:choose>
                            	<c:when test="${fn:length(priceList) < 1 }">
                            		<span class="f13_1" style="color: red;">未找到与虚拟机相同计费方式的磁盘资源：</span>
                            	</c:when>
                            	<c:otherwise>
                            		<span class="f13_1" style="color: red;">请选择与虚拟机相同计费方式的磁盘资源：</span>
                            	</c:otherwise>
                            </c:choose>
					             ...
					             <td align="left" valign="top" bgcolor="#FFFFFF" height="420">
						     		<table width="900" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
						              <tr bgcolor="#92b8c1" height="20">
						                ...
						                <td width="20%" align="center" class="f12">磁盘方案名称</td>
