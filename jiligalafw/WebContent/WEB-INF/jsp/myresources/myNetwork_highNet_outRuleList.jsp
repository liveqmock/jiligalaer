...
<title>我的资源 - 我的网络 - 高级网络 - 出口规则编辑</title>
...
function save(){
	...
	form.action="${ctx}/network/saveOutRule.do";
	waitloading();
	form.submit();
}
function back(){
...
function delOutRole(interfaceId){
	var form = document.forms.listForm;
	form.action="${ctx}/network/delOutRule.do?interfaceId="+interfaceId;
	waitloading();
	form.submit();
}
</script>
...
if(msg!=''){
  ...
  <body onLoad="">
    <form:form modelAttribute="baseVoList" action="${ctx}/network/highOutRule.do" method="post" name="listForm">
		<input type="hidden" name="networkId" id="networkId" value="${networkId }" />
		
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr bgcolor="#ffffff" height="40">
					  	<td width="10"></td>
					  	<td class="f16_1">来宾网络01&nbsp;&nbsp;>&nbsp;&nbsp;出口规则</td>
					  	<td width="10"></td>
					  </tr>
                      <tr>
                      	<td width="10"></td>
					          ...
					          <td align="left" valign="top" bgcolor="#FFFFFF" height="250">
					     		<table width="815" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
					              <tr bgcolor="#92b8c1" height="20">
					                ...
					                <td width="10%" align="center" class="f12">起始端口</td>
					                <td width="10%" align="center" class="f12">终止端口 </td>
					                <td width="10%" align="center" class="f12">ICMP类型</td>
					                <td width="10%" align="center" class="f12">ICMP代码</td>
					            ...
					            <div id="order" style="height:440px; z-index:1; overflow-y: scroll;overflow-x:hidden;">   
					              <table width="815" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
					              	...
					              	<%int i=0; %>
									<c:forEach var="item" items="${outRoleList}" >
								        <%
						                ...
						                <tr bgcolor="<%=bgcolor %>" height="20">
						                  ...
						                  <td width="10%" align="left" class="f12_1">${item.cidrlist }</td>
						                  <td width="10%" align="center" class="f12_1">${item.protocol }</td>
						                  <td width="10%" align="center" class="f12_1">${item.startport }</td>
						                  <td width="10%" align="left" class="f12_1">${item.endport }</td>
						                  <td width="10%" align="center" class="f12_1">${item.icmpcode }</td>
						                  <td width="10%" align="center" class="f12_1">${item.icmptype }</td>
						                  <td width="10%" align="center" class="f12_1">
						                    <input type="button" value="删除" onclick="javascript:delOutRole('${item.interfaceId }');" class="btn_bg" style="width: 40px;"/>
						                  </td>					                  
						                </tr>
						            </c:forEach>
