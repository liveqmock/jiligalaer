...
<title>我的资源 - 我的网络 - 基础网络 - 入口规则编辑</title>
...
function save(){
	...
	form.action="${ctx}/network/saveInRule.do";
	waitloading();
	form.submit();
}
...
function delInRule(interfaceId){
	var form = document.forms.listForm;
	form.action="${ctx}/network/delInRule.do?interfaceId="+interfaceId;
	waitloading();
	form.submit();
}
</script>
...
if(msg!=''){
	alert(msg);
	var groupId = '${groupId}';
	window.location.href="${ctx}/network/inEdit.do?groupId="+groupId;
}
</script>
</head>
  <body onLoad="">
    <form:form modelAttribute="baseVoList" action="${ctx}/network/inEdit.do" method="post" name="listForm">
		<input type="hidden" name="groupId" id="groupId" value="${groupId }" />
		
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr bgcolor="#ffffff" height="40">
					  	<td width="10"></td>
					  	<td class="f16_1">安全组01&nbsp;&nbsp;>&nbsp;&nbsp;入口规则</td>
					  	<td width="10"></td>
					  </tr>
                      <tr>
                      	<td width="10"></td>
					          ...
					          <td align="left" valign="top" bgcolor="#FFFFFF" height="250">
					            ...
					            <div id="order" style="height:440px; z-index:1; overflow-y: scroll;overflow-x:hidden;">   
					              <table width="815" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
					              	...
					              	<%int i=0; %>
									<c:forEach var="item" items="${inRuleList}" >
								        <%
										...
										<tr bgcolor="<%=bgcolor %>" height="20">
						                  ...
						                  <td width="8%" align="center" class="f12_1">
						                  	<input type="button" value="删除" onclick="javascript:delInRule('${item.interfaceId }')" class="btn_bg" style="width: 40px;" />
										  </td>					                  
						                </tr>
						            </c:forEach>
