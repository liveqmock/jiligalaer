...
<form:form modelAttribute="basicRoleVo" action="${ctx}/role/save.do" method="post">
	...
	<table style="width:97%; margin-left: 15px;" border="0">
		...
		<tr>
			<td colspan="4" width="100%">
				<div style="left:40%;position: absolute;height: 50px;">
					<img src="${ctx}/images/btns1.png" alt="保 存" width="101" height="30" border="0" align="absmiddle" style="cursor:pointer;" onclick="javascript:doSave();"/>
			        &nbsp;&nbsp;&nbsp;&nbsp;
			        <img src="${ctx}/images/btn10.png" alt="返 回"" width="101" height="30" border="0" align="absmiddle" style="cursor:pointer;" onclick="javascript:doReturn();"/>		
				</div>
			</td>
		</tr>
	</table>
