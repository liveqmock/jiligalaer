 ...
 <script type="text/javascript">
 	...
 	function userReg(){
		...
		if(!checkTel(document.getElementById("tel").value)){
 		...
 		if(document.getElementById("userBrithday").value==''){
 			alert('出生日期不能为空'); 
 			return false;
 		}
  		...
  		<form:form  modelAttribute="userRegisterVo" action="${ctx}/base/userRegister/saveUserInfo.do"  method="post">
    	    <table width="952" height="470" border="0" cellpadding="0" cellspacing="0" align="center">
				    ...
				    <tr height="25">
				    	...
				    	<td height="25">
				    	  <table align="left" width="100%"  border="0" cellspacing="1" cellpadding="0" bordercolor="#cccccc" style='height:25px; margin:0px; padding:0px; display:inline;'>
						    <tr align="center">
						      <td height="25px">
			    				<form:input path="userPassword" type="password" class="text13" size="30" cssStyle="height:20px;" maxlength="15" onKeyUp='pwStrength(this.value)' onBlur='pwStrength(this.value)'/>
			    				<font size="2" color="red"><form:errors path="userPassword" /></font>
						      </td>
						      <td class="f13" width="35" height="20" id="strength_L"  bgcolor="#eeeeee">弱</td>
						      <td class="f13" width="35" height="20" id="strength_M"  bgcolor="#eeeeee">中</td>
						      <td class="f13" width="35" height="20" id="strength_H"  bgcolor="#eeeeee">强</td>
						    </tr>
						  </table>
				    	</td>
				    ...
				    <tr height="35">
				    	...
				    	<td class="f13" colspan="4" align="center">
				    		...
				    		&nbsp;
			    			<img src="${ctx}/images/btnc1.png" width="120" height="32" border="0" align="absmiddle" onclick="javascript:reset();" style="cursor: pointer;"/>
				    		<!--
				    		&nbsp;
