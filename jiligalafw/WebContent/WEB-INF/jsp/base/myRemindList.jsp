...
function dateQuery(val){
	...
	form.action="${ctx}/remind/myRemind.do";
	loading();
	form.submit();
}
...
function display() {
  ...
  <body onLoad="display();">
    <form:form modelAttribute="basicUserVoList" action="${ctx}/remind/myRemind.do" method="post" name="listForm">
                      ...
                      <tr>
						<td align="left" valign="top">
		                   	...
		                   	<ec:table items="list" var="item" onInvokeAction="query('${queryType }')" form="listForm"
							    ...
							    action="${ctx}/remind/myRemind.do" showPagination="true" cellspacing="1">
								<ec:row>
									...
									<ec:column property="null" title="提醒内容" style="width:85%; text-align: left;" >
									  <span title="${item.message }">
										${fn:substring(item.message,0,70)}...
									  </span>
									</ec:column>
								</ec:row>
							</ec:table>
