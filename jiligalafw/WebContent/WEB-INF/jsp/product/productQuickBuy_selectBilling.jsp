...
function next(){
	...
	if(confirm("确定购买该虚拟机吗？")){
		...
		form.action="${ctx}/quickBuy/finishBuy.do?comPriceType="+comPprice;
		waitloading();
		form.submit();
	}
}
            ...
            <tr>
              ...
              <td align="left" valign="top" bgcolor="#F0F1F2" height="475">
					 ...
					 <table width="98%" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
                    	...
                    	<c:choose>
                    	  <c:when test="${quickBuyVo.priceMode=='0'}">
	                    	  <tr height="20">
	                          	<td width="10%" height="20" align="left" class="f13_1"><input type="radio" name="comPprice" value="compOneTime"/></td>
                          ...
                          <c:otherwise>
	                          <tr height="20" bgcolor="#deecef">
	                            <td width="10%" height="20" align="center" class="f12_1"><input type="radio" name="comPprice" value="compYear" checked="checked"/></td>
	                            <td width="30%" align="left" class="f12_1">年收费</td>
	                         	<td width="30%" align="right" class="f12_1">${quickBuyVo.yearPrice}元</td>
	                         	<td width="30%" align="right" class="f12_1">${quickBuyVo.yearRebatePrice}元</td>
	                          </tr>
	                          <tr height="20" bgcolor="#eef6f7">
	                           <td width="10%" height="20" align="center" class="f12_1"><input type="radio" name="comPprice" value="compMonth"/></td>
	                            <td width="30%" align="left" class="f12_1">月收费</td>
	                         	<td width="30%" align="right" class="f12_1">${quickBuyVo.monthPrice}元</td>
	                         	<td width="30%" align="right" class="f12_1">${quickBuyVo.monthRebatePrice}元</td>
	                          </tr>
	                    	  <tr height="20" bgcolor="#deecef">
	                    	    <td width="10%" height="20" align="center" class="f12_1"><input type="radio" name="comPprice" value="compDay"/></td>
	                            <td width="30%" align="left" class="f12_1">日收费</td>
	                         	<td width="30%" align="right" class="f12_1">${quickBuyVo.dayPrice}元</td>
	                         	<td width="30%" align="right" class="f12_1">${quickBuyVo.dayRebatePrice}元</td>
	                          </tr>
	                           <tr height="20" bgcolor="#eef6f7">
	                    	    <td width="10%" height="20" align="center" class="f12_1"><input type="radio" name="comPprice" value="compHour"/></td>
	                            <td width="30%" align="left" class="f12_1">小时收费</td>
	                         	<td width="30%" align="right" class="f12_1">${quickBuyVo.hourPrice}元</td>
	                         	<td width="30%" align="right" class="f12_1">${quickBuyVo.hourRebatePrice}元</td>
	                          </tr>
                ...
                <%--
                  ...
                  <tr height="30">
                	<td width="4%"></td>
                    <td align="left" class="f15_1"> <input type="hidden" id="basicType" value="${networkType}"/>基础网络IP总收费:</td>
                  </tr>
                 <tr height="30">
                	<td width="4%"></td>
                    <td>
					 <table width="95%" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
                       	<tr bgcolor="#92b8c1" height="20">
                         	<td width="10%" align="center" class="f12">选择</td>
                         	<td width="50%" align="center" class="f12">收费类型</td>
                         	<td width="40%" align="center" class="f12">金额</td>
                        </tr>
                      </table>
                   ...
                   <tr height="30">
                    ...
                    <td>
                       <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                          <tr height="30">
                          	<td width="10%" height="40" align="left" class="f13_1"><input type="radio" name="basicIp" value="ipYear"/></td>
                            <td width="50%" align="center" class="f13_1">周期性收费：</td>
                         	<td width="40%" align="center" class="f13_1">${ippriceVo.yearPrice}元/年</td>
                          </tr>
                          <tr height="30">
                          	<td width="10%" height="40" align="left" class="f13_1"><input type="radio" name="basicIp" value="ipMonth"/></td>
                            <td width="50%" align="center" class="f13_1">周期性收费：</td>
                         	<td width="40%" align="center" class="f13_1">${ippriceVo.monthPrice}元/月</td>
                          </tr>
                    	  <tr height="30">
                    	  	<td width="10%" height="40" align="left" class="f13_1"><input type="radio" name="basicIp" value="ipDay"/></td>
                            <td width="50%" align="center" class="f13_1">周期性收费：</td>
                         	<td width="40%" align="center" class="f13_1">${ippriceVo.dayPrice}元/天</td>
                          </tr>
