...
function next(){
	var networkId=$('input:radio[name="securityGroupId"]:checked').val();
	//if (networkId != null){
              ...
              <td align="left" valign="top" bgcolor="#F0F1F2">
                <table width="336" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="301" align="left" valign="middle" class="f18b2">请选择您维护的安全组</td>
                  </tr>
                  <tr>
                  ...
                  <tr height="30">
                    ...
                    <td>
                      ...
                      <div style="height:310px; z-index:1; overflow-y: scroll; overflow-x: hidden; ">   
                          <table width="670" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
                           <%int rowNumber=0; %>
                           <c:forEach var="item" items="${securityGroupList}" varStatus="status"> 
                            <tr <% if (rowNumber%2 == 0) {%> bgcolor="#deecef" <% } else { %> bgcolor="#eef6f7" <% } %> height="20">
                               ...
                               <td width="10%" align="center" class="f12_1">
                               	<form:radiobutton path="securityGroupId" value="${item.id}" />
                               </td>
                            </tr>
                            </c:forEach>
                          </table>
