...
function next(){
	...
	var cpuSolnId=$('input:radio[name="prodCpuSolnId"]:checked').val();
	if (cpuSolnId != null){
...
function quickBuy(){
  ...
  <body onLoad="">
    <form:form modelAttribute="cloudProductCustomBuyVo" action="${ctx}/customBuy/computResource.do" method="post" name="listForm">
              ...
              <td align="left" valign="top" bgcolor="#F0F1F2">
                <table width="336" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="301" align="left" valign="middle" class="f18b2">请选择您需要的计算资源</td>
                  </tr>
                  <tr>
                  ...
                  <tr height="30">
                    ...
                    <td>
                      ...
                      <div style="height:343px; z-index:1; overflow-y: scroll; overflow-x: hidden;">   
                          <table width="670" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
                            <%int rowNumber=0; %>
                           	<c:forEach var="item" items="${cpuSolnList}" varStatus="status">
	                            <tr <% if (rowNumber%2 == 0) {%> bgcolor="#deecef" <% } else { %> bgcolor="#eef6f7" <% } %> height="20">
	                               ...
	                               <td width="39%" align="left" class="f12_1">${item[5]}</td>
	                               <td width="6%" align="center" class="f12_1">
	                               	<form:radiobutton path="prodCpuSolnId" value="${item[0]}" />
	                               </td>
	                            </tr>
	                        </c:forEach>
