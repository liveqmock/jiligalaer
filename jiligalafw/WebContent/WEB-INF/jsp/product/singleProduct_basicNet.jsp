...
<title>产品管理-单一产品列表-选择资源主页面-基本网络</title>
...
function selectVal(id,prodType){
	var winObj = window.parent.parent.parent;
	winObj.opener.selectedProduct(id,prodType);
	winObj.close();
  ...
  <body onLoad="">
    <form:form modelAttribute="baseVoList" action="${ctx}/singleProd/basicNet.do" method="post" name="listForm">
          ...
          <td align="left" valign="top" bgcolor="#FFFFFF" height="350">
     		...
     		<table width="98%" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
              <tr bgcolor="#92b8c1" height="20">
                ...
                <td width="20%" align="center" class="f12">带宽大小</td>
                <td width="20%" align="center" class="f12">描述</td>
                <td width="20%" align="center" class="f12">选择</td>
              </tr>
            </table>
            
            <%int i=0; %>
            <div id="order" style="height:330px; z-index:1; overflow-y: scroll;overflow-x:no; width: 100%;">
              <table width="97.8%" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
				  ...
				  <c:forEach var="item" items="${list}" >
					...
					<tr bgcolor="<%=bgcolor %>" height="20">
	                  ...
	                  <td width="20%" align="right" class="f12_1">${item.networkRate }</td>
