...
<title>产品管理-单一产品列表-选择资源主页面-模板</title>
...
function selectVal(id,prodType,name){
  ...
  <body onLoad="">
    <form:form modelAttribute="baseVoList" action="${ctx}/singleProd/templateRes.do" method="post" name="listForm">
          ...
          <td align="left" valign="top" bgcolor="#FFFFFF" height="350">
     		...
     		<table width="790" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
              <tr bgcolor="#92b8c1" height="20">
                ...
                <td width="35%" align="center" class="f12">模板名称</td>
				  ...
				  <c:forEach var="item" items="${list}" >
					...
					<tr bgcolor="<%=bgcolor %>" height="20">
	                  ...
	                  <td width="5%" align="center" class="f12_1">
	                  	<input type="radio" name="radio" id="radio1" value="${item.id }" onclick="selectVal('${item.id }','template','${item.name }')">
	                  </td>
	                </tr>
	              </c:forEach>
