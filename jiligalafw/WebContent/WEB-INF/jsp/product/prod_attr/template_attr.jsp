  ...
  <body>
    ...
    <table height="100%" width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
      <tr bgcolor="#deecef" height="25" >
        ...
        <td width="80%" height="25" align="left" class="f12_1">模板</td>
      </tr>   
      ...
      <tr bgcolor="#deecef" height="25" >
        <td width="20%" height="25" align="left" class="f12_1">&nbsp;&nbsp;大小：</td>
        <td width="80%" height="25" align="left" class="f12_1">${mdmVo.size/1024/1024/1024 } GB</td>
      </tr>                                                                                                                        
      <tr bgcolor="#eef6f7" height="25" >
