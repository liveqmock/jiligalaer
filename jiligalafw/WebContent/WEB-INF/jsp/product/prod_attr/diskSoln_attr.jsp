...
<title>产品管理-单一产品-磁盘方案产品属性</title>
  ...
  <body>
    ...
    <table height="100%" width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
      <tr bgcolor="#deecef" height="25" >
        ...
        <td width="80%" height="25" align="left" class="f12_1">磁盘资源</td>
      </tr>   
      ...
      <tr bgcolor="#deecef" height="25" >
        <td width="20%" height="25" align="left" class="f12_1">&nbsp;&nbsp;磁盘大小：</td>
        <td width="80%" height="25" align="left" class="f12_1">${mdmVo.diskSize }</td>
      </tr>                                                                                                                        
      <tr bgcolor="#eef6f7" height="25" >
