...
<title>产品管理-单一产品列表-选择资源主页面-磁盘方案</title>
...
function selectVal(id,prodType,name){
  ...
  <body onLoad="">
    <form:form modelAttribute="baseVoList" action="${ctx}/singleProd/diskResource.do" method="post" name="listForm">
          ...
          <td align="left" valign="top" bgcolor="#FFFFFF" height="350">
     		...
     		<table width="790" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
              <tr bgcolor="#92b8c1" height="20">
                ...
                <td width="35%" align="center" class="f12">磁盘方案名称</td>
                <td width="10%" align="center" class="f12">磁盘大小(G)</td>
                <td width="45%" align="center" class="f12">描述</td>
              ...
              <table width="790" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
				  ...
				  <c:forEach var="item" items="${list}" >
					...
					<tr bgcolor="<%=bgcolor %>" height="20">
	                  ...
	                  <td width="10%" align="right" class="f12_1">${item.diskSize }</td>
	                  <td width="45%" align="left" class="f12_1">${item.displayText }</td>
	                  <td width="5%" align="center" class="f12_1">
	                  	<input type="radio" name="radio" id="radio1" value="${item.id }" onclick="selectVal('${item.id }','diskSoln','${item.name }')">
	                  </td>
	                </tr>
	              </c:forEach>
