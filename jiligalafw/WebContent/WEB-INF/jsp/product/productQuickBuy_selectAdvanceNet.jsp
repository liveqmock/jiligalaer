            ...
            <tr>
              ...
              <td align="left" valign="top" bgcolor="#F0F1F2">
                ...
                <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr height="35">
                	<td width="6%"></td>
                    <td align="left" class="f15_12"><span style="color: #e8be00;font-size:15px;">■</span><span style="color: #e8be00;font-size:15px;">&nbsp;&nbsp;已有网络：</span></td>
                    <td align="right" class="f15_12">
	                    <c:if test="${userFlag == '1'}">
	                    	<img src="${ctx}/images/btn29.png" alt="新增网络" width="101" height="30" border="0" align="absmiddle" style="cursor:pointer;" onclick="javascript:add();"/>
	                    	&nbsp;&nbsp;
	                    </c:if>
					</td>
                  </tr>
                  <tr height="30">
                    ...
                    <td colspan="2">
                      ...
                      <div style="height:302px; z-index:1; overflow-y: scroll; overflow-x: hidden; ">   
                          <table width="670" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
                           <%int rowNumber=0; %>
