...
function next(){
	var secGroups =  document.getElementsByName("secGroup");
	var secGroupId ="";
	var tag = false;
	for ( var i = 0; i < secGroups.length; i++) {
		if (secGroups.item(i).checked) {
			tag = true;
			secGroupId = secGroupId + secGroups.item(i).getAttribute("value");
			secGroupId =secGroupId+",";
			continue;
		}
	}
	var form = document.forms.listForm;
	form.action="${ctx}/quickBuy/hostConfig.do?secGroupId="+secGroupId;
	form.submit();
}
function previous(){
	var form = document.forms.listForm;
...
function getselectFlag(){
	var secGroupIds = '${secGroupId}';
	var sts = secGroupIds.split(",");
	var st = document.getElementsByName("secGroup");
              ...
              <td align="left" valign="top" bgcolor="#F0F1F2" >
                <table width="336" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="301" align="left" valign="middle" class="f18b2">请选您需要的安全组</td>
                  </tr>
                  <tr>
                    ...
                    <td>
					  ...
					  <table width="670" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
                       	<tr bgcolor="#92b8c1" height="20">
                         	...
                         	<td width="40%" align="center" class="f12">安全组名称</td>
                         	<td width="40%" align="center" class="f12">描述</td>
                         	<td width="10%" align="center" class="f12">选择</td>
                        </tr>
                      </table>
                      <div style="height:310px; z-index:1; overflow-y: scroll; overflow-x: hidden; ">   
                          <table width="670" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
                            <%int rowNumber=0; %>
                            <c:forEach var="item" items="${CloudSecurityGroupList}" varStatus="status" >
                               ...
                               <td width="40%" align="left" class="f12_1">${item.description}</td>
                               <td width="10%" align="center" class="f12_1"><input type="checkBox" value="${item.id}" name="secGroup" /></td>
                            </tr>
                            </c:forEach>
                          </table>
					  </div>
