              ...
              <td align="left" valign="top" bgcolor="#F0F1F2" height="560">
                <table width="336" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="301" align="left" valign="middle" class="f18b2">请选择您需要的虚拟机</td>
                  </tr>
                  <tr>
			                        ...
			                        <tr>
			                        	<td width="15" height="35" align="left" valign="middle"></td>
			                     	 	<td colspan="2" align="left" valign="middle" class="f15_1">
			                     	 		<input type="radio" name="prod" id="prodId" checked="checked"
			                     	 			value="${item.cloudMdmProductItem.mdmProduct.id}__${item.cloudMdmProductItem.mdmZone.id}__${item.cloudMdmProductItem.mdmZone.networkType}__${item.cloudMdmProductItem.mdmZone.interfaceId}" />
			                     	 		${item.cloudMdmProductItem.mdmProduct.prodName}
			                     	 	</td>
			                   	   	</tr>
			                      </c:when>
			                      <c:otherwise>
			                        <tr>
			                         	<td width="15" height="35" align="left" valign="middle"></td>
			                         	<td colspan="2" align="left" valign="middle" class="f15_1">
			                         		<input type="radio" name="prod" id="prodId"
			                         			value="${item.cloudMdmProductItem.mdmProduct.id}__${item.cloudMdmProductItem.mdmZone.id}__${item.cloudMdmProductItem.mdmZone.networkType}__${item.cloudMdmProductItem.mdmZone.interfaceId}" />
			                         		${item.cloudMdmProductItem.mdmProduct.prodName}
			                         	</td>
			                       	</tr>
			                       	...
			                       	<tr height="23">
			                        	<td  align="left" valign="middle">&nbsp;</td>
			                      		...
			                      		<td align="left" valign="middle" class="f12_1" style="color: red; font-weight: bold;">
				                       		<a title="">
				                           	${item.yearPrice}元/年 | ${item.monthPrice}元/月 
				                      		</a>
				                      	</td>
			                      	</tr>
			                      	<tr height="23">
			                        	<td  align="left" valign="middle">&nbsp;</td>
			                      		<td align="left" valign="middle" class="f12_1"></td>
			                      		<td align="left" valign="middle" class="f12_1" style="color: red; font-weight: bold;">
				                       		<a title="">
				                            ${item.dayPrice}元/天| ${item.hourPrice}元/小时
				                      		</a>
				                      	</td>
			                      	</tr>
			                      </c:when>
