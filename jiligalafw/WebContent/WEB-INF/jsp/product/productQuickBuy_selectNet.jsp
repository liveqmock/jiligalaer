                ...
                <table width="729" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr height="30">
                    ...
                    <td>
                      ...
                      <div style="height:245px; z-index:1; overflow-y: scroll; overflow-x: hidden; width: 97%">   
                          <table width="98%" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
                            <tr bgcolor="#deecef" height="20">
                               ...
                               <td width="40%" align="left" class="f12_1">带宽 1Mbps</td>
                            ...
                            <tr bgcolor="#deecef" height="20">
                               ...
                               <td width="40%" align="left" class="f12_1">带宽 2Mbps</td>
                               <td width="10%" align="center" class="f12_1"><input type="radio" value="2" name="radio1" /></td>
                            </tr>
                            <tr bgcolor="#eef6f7" height="20">
                               <td width="10%" align="center" class="f12_1">3</td>
                               <td width="40%" align="left" class="f12_1">5Mbps</td>
                               <td width="40%" align="left" class="f12_1">带宽 5Mbps</td>
                               <td width="10%" align="center" class="f12_1"><input type="radio" value="2" name="radio1" /></td>
                            </tr>
                            <tr bgcolor="#deecef" height="20">
                               <td width="10%" align="center" class="f12_1">4</td>
                               <td width="40%" align="left" class="f12_1">10Mbps</td>
                               <td width="40%" align="left" class="f12_1">带宽 10Mbps</td>
                               <td width="10%" align="center" class="f12_1"><input type="radio" value="2" name="radio1" /></td>
                            </tr>
                          </table>
					  </div>
