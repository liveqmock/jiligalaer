...
<title>产品管理-单一产品列表-选择资源主页面-网络方案</title>
    ...
    <form:form modelAttribute="baseVoList" action="${ctx}/singleProd/computResource.do" method="post" name="listForm">
      <table width="806" border="0" cellpadding="0" cellspacing="0">
          ...
          <td align="left" valign="top" bgcolor="#FFFFFF" height="350">
     		...
     		<table width="98%" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
              <tr bgcolor="#92b8c1" height="20">
                ...
                <td width="40%" align="center" class="f12">网络方案名称</td>
            ...
            <%int i=0; %>
            <div id="order" style="height:350px; z-index:1; overflow-y: scroll;overflow-x:hidden; width: 100%;">
              <table width="98%" border="0" cellspacing="1" cellpadding="1" bgcolor="#eeeeee">
				  ...
				  <c:forEach var="item" items="${list}" >
					...
					<tr bgcolor="<%=bgcolor %>" height="20">
	                  ...
	                  <td width="10%" align="right" class="f12_1">${item.networkRate }</td>
		...
		<!--
       	<table width="806" border="0" cellpadding="0" cellspacing="0">
           <tr>
             <td align="center" valign="middle" bgcolor="#FFFFFF" height="380">
	     		<table width="60%" border="0" cellspacing="1" cellpadding="1" >   		
	              <tr bgcolor=#ffffff height="20">
	                <td width="50%" align="center" class="f12_1">
	                	带宽：&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="ipNum" id="ipNum" value=""/> Mbps
	                </td>
	              </tr>              
	            </table>
             </td>
